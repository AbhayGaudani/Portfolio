      ...
      <div className="z-10  pb-8 2xl:w-226 xl:w-160 bg-[#1e1e1f]  ml-118 lg:px-5 md:px-4 sm:px-4 xs:px-2.5 xxs:pr-1.5">
        <div className="animation-fadeIn">
          ...
          <div className=" text-white">
            ...
            <div className="2xl:h-80 2xl:w-195 2xl:ml-10 md:mr-3 sm:mr-2 xxs:mr-2 lg:mr-4 lg:h-80 xl:h-76 lg:pt-5 md:pt-4 sm:pb-5 sm:pt-3 xxs:pt-3 xxs:pb-5 mt-12 md:pb-5 lg:pb-0 2xl:px-7 2xl:py-7  inset-shadow-icon inset-shadow-neutral-700 rounded-2xl shadow-icon  items-center justify-center">
              <motion.div
