      ...
      <div className="z-10  pb-8 2xl:w-226 xl:w-160 bg-[#1e1e1f]  ml-118 lg:px-5 md:px-4 sm:px-4 xs:px-2.5 xxs:pr-1.5">
        <div className="animation-fadeIn">
          ...
          <div className=" text-white">
            ...
            <div className="2xl:h-125 2xl:w-195 2xl:ml-10 md:mr-3 sm:mr-2 xxs:mr-2 lg:mr-4 lg:h-115 xl:h-120 lg:pt-5 md:pt-4 sm:pb-5 sm:pt-3 xxs:pt-3 xxs:pb-5 mt-12 md:pb-5 lg:pb-0 2xl:px-7 2xl:py-7  inset-shadow-icon inset-shadow-neutral-700 rounded-2xl shadow-icon  items-center justify-center">
              <motion.div
              ...
              >
                <p className="pl-5 lg:pt-5 md:pt-3 sm:pt-0 xxs:pt-1 sm:text-[17px] xxs:text-[12px] xs:text-sm">
                  Shopify{" "}
                  <span className="2xl:ml-149 xl:ml-114 lg:ml-129 md:ml-114 sm:ml-93 xs:ml-56 xxs:ml-53.5">
                    90%
                  </span>
                </p>
                <div className="2xl:w-170 xl:w-135 lg:w-150 md:w-136 sm:w-115 xs:w-75 xxs:w-68 xxs:h-1 rounded-full ml-5 sm:h-2 xs:h-1.5 mt-1 bg-gradient-to-r from-[#ffd558] from-90% to-neutral-600 to-0%"></div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, translateY: "50%" }}
                whileInView={{ opacity: 1, translateY: "0" }}
              ...
              >
                <p className="pl-5 lg:pt-5 md:pt-3 sm:pt-0 xxs:pt-1 sm:text-[17px] xxs:text-[12px] xs:text-sm">
                  React Js{" "}
                  <span className="2xl:ml-148 xl:ml-113 lg:ml-128 md:ml-113 sm:ml-92 xs:ml-55 xxs:ml-52.5">
                    70%
                  </span>
                </p>
                <div className="2xl:w-170 xl:w-135 lg:w-150 md:w-136 sm:w-115 xs:w-75 xxs:w-68 xxs:h-1 rounded-full ml-5 sm:h-2 xs:h-1.5 mt-1 bg-gradient-to-r from-[#ffd558] from-70% to-neutral-600 to-0%"></div>
              ...
              >
                <p className="pl-5 lg:pt-5 md:pt-3 sm:pt-0 xxs:pt-1 sm:text-[17px] xxs:text-[12px] xs:text-sm">
                  Git/Github{" "}
                  <span className="2xl:ml-144 xl:ml-109 lg:ml-124 md:ml-108 sm:ml-88 xs:ml-51 xxs:ml-49.5">
                    70%
                  </span>
                </p>
                <div className="2xl:w-170 xl:w-135 lg:w-150 md:w-136 sm:w-115 xs:w-75 xxs:w-68 xxs:h-1 rounded-full ml-5 sm:h-2 xs:h-1.5 mt-1 bg-gradient-to-r from-[#ffd558] from-70% to-neutral-600 to-0%"></div>
